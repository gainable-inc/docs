...
## Adding to an app that already exists

Asking for a feature on a built app is its own skill — name the page, name the component, and read the plan card before accepting it. See [Changing a built app](/prompting/refining).

Each feature has a page of its own, with the prompts and the options that go with it:

| Want to add | See |
|---|---|
| Charts and KPI cards | [Charts](/skills/chartjs) |
| A kanban board | [Kanban](/skills/kanban) |
| Chat, comments, presence | [Collaboration](/skills/weavy) |
| Filters, search, view layout | [Views](/building/views) |
| Live updates | [Real-time](/building/real-time) |
| Themes, colours, layout | [Design](/skills/design) |
