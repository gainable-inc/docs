...
Gainable shows you a plan first. Accept it, and the kanban board is added to your existing app, preserving everything you've already built.

<Tip>
Changing an app follows different rules from building one — name the page you mean, keep each request to one change, and read the plan before accepting. See [Changing a built app](/prompting/refining).
</Tip>
