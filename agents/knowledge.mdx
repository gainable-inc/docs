...
<Steps>
  <Step title="Create your agent">
    Set up an agent with a name, instructions, and data access configuration.
  </Step>
...
Knowledge bases and [data access](/agents/functions) work together to give your agent maximum capability:
