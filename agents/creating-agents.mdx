...
<Steps>
  ...
  <Step title="Agent Planner analyzes">
    The Agent Planner determines the agent's name, instructions, data access, and configuration.
  </Step>
...
| **Data access** | MCP Server connection to your app data — read, update, and insert records. Optionally restricted with scopes |
...
<CardGroup cols={2}>
  <Card title="Data access" icon="database" href="/agents/functions">
    Connect your agent to app data via MCP
  </Card>
