...
<Tip>
Agents can also access data synced from external sources via [datasets](/building/data-connectors). Add sources like HubSpot or Google Sheets to a dataset, sync the data, and your agent can query it alongside your app data.
</Tip>
