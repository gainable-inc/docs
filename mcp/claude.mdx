...
The Gaia connector is a **remote MCP server**, which is what Claude calls a *custom connector*. Add it once and it appears everywhere you use Claude — chat on the web, Cowork, Desktop, and mobile.
  ...
  <Tab title="Free, Pro, and Max">
    <Steps>
      ...
      <Step title="Connect and sign in">
        ...
        <Tip>
        The consent screen has a checkbox — *"Also let it write code in your apps."* Leave it off unless you want [author mode](/mcp/tools#author-mode).
        </Tip>
      </Step>
    </Steps>
  </Tab>
...
```
Build me an app from this planning sheet
```
...
| Author mode | Available if granted | Available if granted |
...
- **Change or revoke it in Gainable** — [Account → Connections](https://build.gainable.dev/account/connections). This is also where you turn author mode on or off without reconnecting.
