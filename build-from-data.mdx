...
Your existing data becomes the specification. Instead of writing a prompt that describes your app from scratch, the AI reads your actual schema from your datasets, detects what domain you're in, and proposes an app tailored to your data.
...
| **Data** | Data models created from your description | Derived from your datasets and connected sources |
...
<CardGroup cols={2}>
  <Card title="Set up datasets" icon="plug" href="/building/data-connectors">
