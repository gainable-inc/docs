...
You don't have to build in the browser. The **Gaia harness** is accessible via a remote [MCP](https://modelcontextprotocol.io) server, so the AI agent you already work in can drive it for you — describe what you want and it builds, refines, and publishes the app on your behalf.
